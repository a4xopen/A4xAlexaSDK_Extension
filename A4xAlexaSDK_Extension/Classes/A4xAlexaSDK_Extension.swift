...
fileprivate let ModuleName = "A4xAlexaSDK"
//fileprivate let ModuleName = "AddxAi"

fileprivate let ProjectName = "AddxAi"

public extension CTMediator {
    @objc func A4xAlexaSDK_getDeviceListVC(nav: UINavigationController, deviceId: String, callback: @escaping (String)->Void) -> UIViewController? {
    ...
    @objc func A4xAlexaSDK_webRtcSDKInit(params: [AnyHashable : Any], callback: @escaping (String) -> Void) {
    ...
    @objc func A4xAlexaSDK_signalConnState(params: [String : Any], callback: @escaping (Int) -> Void) {
        let params:[AnyHashable:Any] = [
            "callback": callback,
    ...
    // 连接webSocket
    @objc func A4xAlexaSDK_connectWebSocket(sn: String, apAddr: String, uid: String, callback: @escaping (String) -> Void) {
        let params:[AnyHashable:Any] = [
            "callback": callback,
            "sn":sn,
            "apAddr":apAddr,
    ...
    // websocket发送
    @objc func A4xAlexaSDK_sendSignalMessage(messageType: Int, messageJson: String, callback: @escaping (String) -> Void) {
        let params:[AnyHashable:Any] = [
            "callback": callback,
    ...
    // 销毁Player
    // sn: 设备序列号
    @objc func A4xAlexaSDK_destoryPlayer(sn: String, callback: @escaping (String) -> Void) {
        let params:[AnyHashable:Any] = [
            "callback": callback,
            "sn":sn,
            kCTMediatorParamsKeySwiftTargetModuleName: ModuleName
    ...
    @objc func A4xAlexaSDK_showSwift(callback: @escaping (String) -> Void) -> UIViewController? {
        let params = [
            "callback": callback,
    ...
    @objc func A4xAlexaSDK_showObjc(callback: @escaping (String) -> Void) -> UIViewController? {
